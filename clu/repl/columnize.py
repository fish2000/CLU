...
def computed_displaywidth():
    """ Figure out a reasonable default with.
        ...
        Use os.environ['COLUMNS'] if possible, and failing that use 80.
    """
    try:
...
def columnize(array, displaywidth=80,
    ...
    """ Return a list of strings as a compact set of columns arranged
        ...
        are separated by two spaces - one was not legible enough. Set
        "colsep" to adjust the string separate columns. Set `displaywidth'
