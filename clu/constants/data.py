...
MODNAMES = ('clu.compilation',
            ...
            'clu.config.filebase',
            'clu.config.formats',
            'clu.config.formats.jsonfile',
            'clu.config.formats.picklefile',
            'clu.config.formats.tomlfile',
            'clu.config.formats.yamlfile',
            'clu.config.settings',
            'clu.constants',
            'clu.constants.enums',
            'clu.csv',
