...
* [`config`][clu.config]: Tons of useful things for dealing with your app’s configuration. These are centered
    ...
    for manipulating namespace strings, [`utils`][clu.config.keymaputils] has more general utility functions (right now
...
[clu.config.keymaputils]: https://github.com/fish2000/CLU/tree/master/clu/config/utils.py
